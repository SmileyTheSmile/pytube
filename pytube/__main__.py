...
class YouTube:
    ...
    def __init__(
        ...
        self._initial_data: Optional[str] = None
        ...
        self.video_id: Optional[str] = extract.video_id(url)
        ...
        self.allow_oauth_cache: bool = allow_oauth_cache
    ...
    @property
    def streaming_data(self) -> Optional[Dict]:
        """
        Returns "streamingData" key value from video info dictionary.
        """
    ...
    def fmt_streams(self) -> List[Stream]:
        ...
        # TODO https://github.com/pytube/pytube/issues/1054
        try:
            extract.apply_signature(dict(*stream_manifest), self.vid_info, self.js)
    ...
    @property
    def max_res_thumbnail_url(self) -> str:
        """
        Get the url of the highest quality of the thumbnail image.
        """
        thumbnail_details = (
        ...
        if thumbnail_details:
            return thumbnail_details[-1]["url"]  # last item has max size
        return f"https://img.youtube.com/vi/{self.video_id}/maxresdefault.jpg"

    @property
    def thumbnail_urls(self) -> List[str]:
        """
        Get the urls of all versions of the thumbnail image.
        """
        thumbnail_details = (
            self.vid_info.get("videoDetails", {})
            .get("thumbnail", {})
        ...
        if thumbnail_details:
            return [thumbnail["url"] for thumbnail in thumbnail_details]
        return [f"https://img.youtube.com/vi/{self.video_id}/maxresdefault.jpg"]
    ...
    def bypass_age_gate(self):
        """
        Attempt to update vid_info by bypassing the age gate.
        """
        innertube = InnerTube(
